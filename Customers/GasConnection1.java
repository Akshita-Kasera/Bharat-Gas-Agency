...
public class GasConnection1 extends Customer {
    ...
    public GasConnection1(String name, String street, String area, String pincode, String mobile, int numberOfCylinders) {
