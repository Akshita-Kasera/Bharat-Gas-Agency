import gasBooking.*;
import  static gasSupplier.gasAgency1.*;
...
public class Main {
    ...
    public static void cylinderCount(Delivery1[] obj) {
        String[] months = new String[]{"January", "February ", "March ", "April", "May", "June", "July", "August", "September", "October", "November", "December"};


        for (Delivery1 delivery : obj) {
            count = 0;
    ...
    public static void checkLateDel(Delivery1[] obj) {
        String[] months = new String[]{"January", "February ", "March ", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
        ...
        for (Delivery1 delivery : obj) {
            if (delivery.status.equals("D") && delivery.amount == 783.75) {
                ...
                cal2.setTime(delivery.dt_2);
                int monthIdx = cal2.get(Calendar.MONTH);
    ...
    public static void numOfSingleCylinders(Delivery1[] obj) {
    ...
    public static void DeliveryDetails(Delivery1[] obj) {
    ...
    public static void printReport(Delivery1[] obj) {
    ...
    public static void printInvoice (Delivery1[] obj) {
        Date d = new Date();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*********************************************************************");
        Delivery1[] deliveryObject = new Delivery1[5];
        deliveryObject[0] = new Delivery1("Rahul","4th Avenue","Sectore -2","410210","9994987779",1);
        deliveryObject[1] = new Delivery1("Malay","panvel Road","Sector-13","410210","9995556668",2);
        deliveryObject[2] = new Delivery1("Rushikesh","Belapur Road","Sector-12","410210","77766668889",3);
        deliveryObject [3] = new Delivery1("Rushi","Amey Sco","Sector-12","410210","9854777777",2);

        for (Delivery1 delivery : deliveryObject){
